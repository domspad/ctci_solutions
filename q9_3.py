...
""" a more elegant binary search to find shift
	
	I realized binary search is not as straight-forward to implement
	as it is to explain, so I had to clear up some issues with 
		- ensuring
"""
